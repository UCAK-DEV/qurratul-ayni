...
interface HomeUIProps {
  chapters: Chapter[];
  selectedNafila: NafilaRecommendation | null;
...
export default function HomeUI({ chapters, selectedNafila, hijriFormatted }: HomeUIProps) {
      ...
      <div className="relative z-10 max-w-6xl mx-auto space-y-16">
        ...
        <header className="islamic-pattern-header space-y-4 text-left pb-2">
          ...
          <p className="font-reading text-lg text-white/70 max-w-2xl leading-relaxed">
            Recueil de recommandations spirituelles et de jurisprudence islamique pour le mouride, aujourd’hui le <span className="text-gold font-medium">{hijriFormatted}</span>.
          </p>
        </header>
