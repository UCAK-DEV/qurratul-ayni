            ...
            <AnimatePresence>
              {isOptionsMenuOpen && (
                <motion.div
                  ...
                  exit={{ opacity: 0, y: 10 }}
                  className="absolute bottom-full right-0 mb-2 p-4 bg-emerald-950-dynamic/90 backdrop-blur-lg rounded-xl shadow-lg border border-white/10 flex flex-col gap-4"
                >
