...
export default function ChapitreMariage() {
  ...
  const sectionsMariage = [
    ...
    { letter: "B", title: "LA CÉLÉBRATION", ar: "الاحتفال بالزواج", sub: ["Formalités rituelles", "Sunna de la cérémonie"] },
    { letter: "C", title: "L’ACTE CONJUGAL", ar: "الجماع", sub: ["Éthique et invocations", "Droits respectifs"] },
    { letter: "D", title: "LA FEMME ENCEINTE", ar: "المرأة الحامل", sub: ["Précautions à prendre", "Santé et spiritualité"] },
    { letter: "E", title: "LE BAPTÊME", ar: "العقيقة", sub: ["Le nom de l'enfant", "Sacrifice et mérites"] },
    { letter: "F", title: "REMÈDES POUR L’ENFANT", ar: "علاجات الطفل", sub: ["Maux d'oreilles", "Gadam", "Digestion"] },
    { letter: "G", title: "LE SEVRAGE", ar: "الفطام", sub: ["Période et transition", "Bien-être de l'enfant"] },
    { letter: "H", title: "L’ÉDUCATION", ar: "تربية الطفل", sub: ["Valeurs islamiques", "Responsabilité"] }
  ];
  ...
  return (
    <main className="min-h-screen bg-[#010302] text-white pt-24 pb-48 px-6 selection:bg-gold/30 overflow-x-hidden">
      ...
      <div className="fixed inset-0 pointer-events-none">
        ...
        <div className="absolute bottom-0 right-0 w-[40vw] h-[40vh] bg-blue-900/5 blur-[100px] rounded-full" />
      </div>
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        {/* GRID DES SECTIONS - 2 COLUMNS FOR STRUCTURE */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {sectionsMariage.map((item, idx) => (
            <motion.div
              ...
              className="group relative p-10 rounded-[2.5rem] bg-white/[0.02] border border-white/5 hover:bg-white/[0.05] hover:border-gold/30 transition-all duration-500 cursor-pointer overflow-hidden h-[300px] flex flex-col justify-between"
            >
              {/* LARGE BACKGROUND LETTER */}
              <span className="absolute -bottom-6 -right-4 text-[200px] font-black leading-none select-none pointer-events-none transition-all duration-700 opacity-[0.02] group-hover:opacity-[0.06] group-hover:-translate-y-4" 
              ...
              <div className="relative z-10 mt-8 flex items-center gap-2 text-[10px] font-black uppercase tracking-widest text-gold opacity-0 group-hover:opacity-100 transition-all translate-x-[-10px] group-hover:translate-x-0">
                Accéder à la section <span className="material-symbols-rounded text-sm">arrow_forward</span>
              </div>
            </motion.div>
          ))}
        </div>
