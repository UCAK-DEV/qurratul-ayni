/**
 * Script de mise à jour Supabase avec FIDÉLITÉ ABSOLUE AUX MOTS ET PHRASES DE L'UTILISATEUR
 * Seules les pures fautes typographiques / espaces brisés sont ajustées.
 */
...
const page3_blocks = [
  ...
  },
  {
    type: "text_block",
    content: [
      "Il n’y a de divinité que Dieu. Son règne est sans partage. C’est Lui qui décide de tout. C’est Lui qui fait, c’est Lui qui défait. Il n’a besoin de l’assistance de personne, il ne demande l’autorisation de personne. Il n’agit que par sa Propre Volonté en toute chose en raison de Son Omnipuissance, en raison de Son Omniscience, en raison de sa seule Volonté. Il ne fait recours à personne mais tout le monde a besoin de Lui. Il préexiste à tous et il est éternel. Il entend, il voit, il parle, mais Sa Perception est sans commune mesure avec celle des créatures. Il ne ressemble à rien, à personne. Rien de ce que l’on peut imaginer ou concevoir par la pensée ou par la parole n’est semblable aux attributs de Dieu. Il n’a point enfanté, Il n’a pas été enfanté. Il n’est le parent de personne. Toute créature est Son serviteur. Il connaît tout, Il n’ignore rien, Il est Omniprésent, Il a le don de l’ubiquité : la solitude ne doit pas nous faire oublier qu’Il est partout avec nous, qu’il est témoin de nos actes et de nos paroles, Il les enregistre, n’en oublie aucun et nous les rétribuera en conséquence. Il connaît la pensée de chacun de nous, aussi nombreux que nous soyons, quelle que soit la diversité des idées émises. Chacun de nous comparaîtra seul devant Lui et croira alors être Sa seule créature. Il est le Créateur, Il nous fait vivre par Sa Grâce, Il fait, Il répand ses bienfaits sur nous. C’est Lui qui met fin à notre existence et nous ressuscite sans aucun doute. Après nous avoir ressuscités, Il nous rassemblera en un jour, en un lieu et nous lui rendons compte de nos actes, chacun en ce qui le concerne. Après examen de nos actes, Il nous enverra au paradis ou en enfer suivant que nos œuvres auront été bonnes ou mauvaises. Sa décision sera sans appel et chacun ne se préoccupera que de son propre sort."
    ]
  }
];
...
const page4_blocks = [
  {
    type: "text_block",
    content: [
      "Notre Prophète Mouhammadou Rassoû Loulahi (PSL), Service de Dieu, est son Messager qu’il a envoyé auprès de tout le monde. Tout ce qu’il dit, tout ce qu’il fait est conforme aux instructions divines. Celui qui en conteste une partie, si petite soit-elle, est un mécréant. Qui en retranche ou en rajoute tant soit peu est digne du plus grand mépris. S’il ne s’en repent pas, il sera précipité dans les feux de l’enfer. L’objet de sa mission est de nous révéler que nous devons nous soumettre à ses recommandations. La plus importante parmi celles-ci est la prière (cinq fois par jour)."
    ]
  }
];
...
const page5a_blocks = [
  ...
  },
  {
    ...
    content: [
      {
        titleFr: "Les pratiques obligatoires du lavage (farata)",
        titleAr: "الفراض",
        items: [
      ...
      },
      {
        ...
        items: [
          ...
          "5. Faire passer l'eau par les oreilles en prenant soin de ne pas la trop faire pénétrer de peur d'avoir des ennuis d'audition (s'assurer également que les aisselles, les autres parties cachées du corps et les replis de la peau sont tous mouillés)"
        ]
      }
    ]
  }
...
const page5b_blocks = [
    ...
    content: [
      {
        ...
        paragraphs: [
          ...
          "S’il s’agit de toilette, il est méritoire d’introduire le pied gauche et dire avant d’entrer : « Bismilahi allahouma iniya a hons oubika minal khouboussi wal khabâ issi. » Une fois à l’intérieur, on ne prononce plus la formule.",
          "Il est aussi méritoire de sortir par le pied droit et dire : « Bismilahi alhamdoulilahi lazi azhaba anil âzâ wa hâfâni. »",
  ...
  },
  {
    ...
    content: [
      ...
      "Après cela, lever la tête vers le ciel et dire ceci : Achadouane lahilaha illalah wahdahô la charika lahô wa ach hadou annas seydina Mouhamadane sala lahô tahala aleyhi wassalama. Abdouho wa rassoulouhou ala houmadj halna minattawa bîna wadj halna minal moutatakhirina wadj halna mine ibâdika sahilina wa add khilnâfildjanati wa bahidna mina nâri allahouma sali al la seydina Mouhamadine wa alla ali seydina Mouhamadine wa salim."
    ]
  },
  {
    type: "comparison",
    content: [
      {
        titleFr: "Les pratiques obligatoires de l’ablution (farata)",
        titleAr: "الفراض",
        items: [
      ...
      {
        titleFr: "Les pratiques traditionnelles de l’ablution (Souna)",
        titleAr: "السنن",
        items: [
...
const page5c_blocks = [
  ...
  },
  {
    ...
    content: [
      {
        titleFr: "Les pratiques obligatoires de la lustration pulvérale (farata)",
        titleAr: "الفراض",
        items: [
...
const page5d_blocks = [
  {
    ...
    content: [
      ...
      {
        label: "LES EAUX COURANTES ET SOURCES",
        paragraphs: [
      ...
      {
        label: "CONJONCTIVITE ET PANSEMENTS",
        paragraphs: [
...
const page5e_blocks = [
  {
    ...
    content: [
      ...
      {
        label: "RECONNAISSANCE DE L'ARRÊT",
        paragraphs: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "- Elle ne doit toucher au Coran que pour l’enseigner ou l’étudier, mais elle peut le réciter.",
...
async function main() {
  console.log("🚀 Lancement de la mise à jour STRICTE de la DB sans aucune modification de sens...\n");
  ...
  console.log("\n✅ Toutes les mises à jour strictes sont terminées !");
}
