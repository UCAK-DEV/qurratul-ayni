/**
 * Script de mise à jour Supabase avec TOUS les détails du livre pour les pages :
 * 2 (Préface & Avant-propos), 3 (Unicité de Dieu), 4 (L'Envoyé), 5 (Intro Pratiques Religieuses),
 * 5-a (Purification), 5-b (Ablutions), 5-c (Tayamoum), 5-d (Souillures),
 * 5-e (Menstrues), 5-f (Lochies), 6 (Prière)
 */
...
const page2_blocks = [
  {
    ...
    content: [
      ...
      "C’est un livre que l’on peut dénommer le Nid parce que d’abord c’est un abri ; il aura été le fruit de recherches entreprises à travers des livres rares, chers et anciens. Il contient des connaissances et des secrets que les chefs religieux de l’époque considéraient comme leur patrimoine personnel ; et pour une tant soit peu il fallait passer des années et des années à travailler au service du détenteur.",
      "Par cette œuvre colossale nous pensons que nous sommes arrivés à ouvrir une brèche qui permet aux francophones de mieux pratiquer le soufisme et de mieux se préparer pour l’au-delà.",
      "Pour terminer j’insiste sur le fait que ce livre est un recueil. Aussi peut-il contenir des idées que le Cheikh n’a fait que rapporter.",
      "Nous prions le Tout Puissant pour qu’il accepte cette œuvre et qu’il en fasse un creuset qui aidera à la formation de citoyens et de musulmans dignes de ce nom, afin que tout le monde puisse vivre ensemble dans la paix et dans la concorde.",
      "Docteur Khadim Awa Balla Mbacké (Pédiatre à l’Hôpital de Kaolack)"
    ]
  },
  {
    type: "split_text",
    content: [
      {
        label: "AVANT – PROPOS",
        paragraphs: [
          "L’expérience non linguistique d’une chose est un préalable indispensable à la compréhension de cette chose. Voilà qui en dit long sur la complexité de notre entreprise de traduction, l’exactitude de la traduction étant intimement liée à la maîtrise des concepts de départ et de celles d’arrivée. Or nous n’avons jamais appris à manipuler des concepts dans cette langue qui est nôtre, le WOLOF, en outre, le message religieux que nous transposons du wolof au français ne nous est familier qu’autant qu’il concernait les pratiques culturelles de tous les jours.",
          "Seul le vif intérêt que le livre a suscité en nous nous a poussés à vouloir en faire profiter à ceux d’entre nos coreligionnaires qui n’ont pas eu la chance de pouvoir lire le « WOLOFAL » (texte wolof écrit à partir de l’alphabet arabe) dans le texte. Aussi ne prétendons-nous nullement proposer une traduction parfaite étant entendu que même si nous étions des spécialistes en la matière il n’existe pas d’équivalence complète entre unités linguistiques provenant de langues différentes. Inutile donc de préciser que nous avons trahi le texte original. Pour limiter les dégâts dans la mesure du possible nous avons quelquefois laissé certains vocables non traduits, non sans les avoir mis entre guillemets.",
          "Par ailleurs aux difficultés rencontrées dans la traduction proprement dite viennent s’ajouter d’autres difficultés non moins importantes, difficultés liées entre autres à la transcription avec les caractères latins de versets ou de sourates arabes que nous n'avons pas jugé utile de traduire : il s'agit en l'occurrence de prières à dire en arabe. Dans le cas d'espèces, nous avons hésité entre l'alphabet « sénégalais » et l'alphabet français avant d'opter pour ce dernier qui a plus de chance d'être maîtrisé par nos lecteurs.",
          "C’est ainsi que nous avons préféré le « KH » français au « X » de l’alphabet « sénégalais » pour transcrire le phonème initial du mot « Khouratoul Ayni », titre originel de l’ouvrage.",
          "Enfin il nous a paru mieux indiqué de laisser leur transcription arabe aux sourates et versets devant servir de breuvage ou à frictionner le corps dans certaines circonstances. Les extraits en question sont regroupés en annexe à la fin de l’ouvrage.",
  ...
  },
  {
    ...
    content: [
      {
        label: "PROJET DE L'AUTEUR",
        paragraphs: [
          "Alhamdou li Lahi Rabil halamina wa sala Lahou hala saydina Mouhammadine wa hala alihi wa sahbihi wa salama tasliimane.",
          "Après avoir rendu grâce à Dieu, dans toute sa grandeur, prié sur son Prophète (PSL), nous nous proposons de rassembler dans ce livre, tout ce qu’il n’est pas permis d’ignorer à une personne majeure. Nous commençons par attester l’unicité de Dieu et rappeler ceux de ses attributs que toute personne majeure doit connaître : croire à cette unicité, au jugement dernier, à l’existence des anges, aux livres révélés par l’intermédiaire des prophètes, au destin, émanation de la volonté divine, croire au Prophète Mouhammad (PSL) et à tous les autres prophètes de Dieu.",
          "Nous nous proposons de faire connaître tous les devoirs dont toute personne majeure doit s’acquitter en propre ; la manière de les faire comme la prière rituelle, la purification, le pèlerinage à la Mecque, la Zakat (dîme), le jeûne, les pratiques obligatoires et les pratiques traditionnelles, tout ce qui est de nature à les entacher de nullité, les pratiques obligatoires dont l’acquittement par certains en dispense les autres, mais dont le manquement général constitue un péché grave pour toute la communauté : sont de celles-là, la toilette d’un mort, la prière sur un mort, l’inhumation d’un mort, ainsi de suite…, quelques pratiques traditionnelles renforcées telles que le witr, la prière des deux fêtes (ou hite) : Korité, Tabaski ; certaines prières surérogatoires et tant d’autres, des choses recommandées comme le mariage et les obligations qui s’y rattachent telles que le divorce, la retraite légale (idda), etc…",
          ...
          "De faire connaître les prières à dire à l’intention d’un enfant et tout ce qui est de nature à le protéger pendant sa croissance, les remèdes qu’il faut à une personne maladive et comment circoncire un enfant, comment égorger, comment sacrifier pendant la Tabaski, certains aliments dont le crédit est prohibé, certains choses dont l’échange doit reste équitable, les devoirs du croyant envers son voisin, comment assister un mourant, comment saluer ; les prières à faire lors de l’apparition du croissant lunaire, les prières à faire pendant certains jours de l’année, certains effets que Dieu a toujours liés à certaines causes comme de mourir avec la foi ou sans la foi, ce qui apporte la fortune et le contraire, la longévité et la bonne santé, les jours recommandés pour certaines choses et comment on aimerait qu’on lise le Coran, comment invoquer Dieu, comment faire l’aumône, certaines prières surérogatoires de la semaine et du mois de ramadan, comment prier sur le prophète (PSL).",
          "De faire connaître la nécessité du repentir, sa nature, les signes précurseurs de la fin du monde, de même que certaines recommandations dont l’observation entraîne la rémission de tous les péchés commis et à commettre.",
          "Voilà en résumé, ce que nous nous proposons de développer dans ces lignes. Nous avons choisi les versions les plus communément admises, car dans certains cas, les avis sont partagés.",
          "Puisse le Tout Puissant exaucer tous nos vœux et nous permettre de finir nos jours en bon musulman."
        ],
        arabic: "اللَّهُمَّ ثَبِّتْنَا عَلَى دِينِكَ الْإِسْلَامِ...",
        translation: "« Alahouma sabitna hala dinikal islami | Wah fazhou haleyna fi hayatina wakinda mamâtinâ | Wabahda wa fâtina wa ahtinâ asdakhal irâdati | Wa ahsana tawakouli wa libassa takhaw a wa toula houmri fi housni hamaline | Wa sahati riskhine wa sihati badanine. | Wa housnal khâtimati wa sahaddatt a daraïni maha kifayati amaïnima | Wa doukhoulal djan ati bikhaïri issabine | Amine ya rabal alamina. »"
      },
      {
        label: "NOTE DE L'AUTEUR",
        paragraphs: [
          "Cher lecteur, sache enfin qu’aucune œuvre humaine n’est parfaite. Un auteur peut toujours, après relecture se rendre compte des insuffisances de son œuvre. Cette opinion est largement répandue."
        ]
      }
    ]
  }
...
const page3_blocks = [
  ...
  },
  {
    ...
    content: [
      ...
      "Il connaît tout, Il n’ignore rien, Il est Omniprésent, Il a le don de l’ubiquité : la solitude ne doit pas nous faire oublier qu’Il est partout avec nous, qu’il est témoin de nos actes et de nos paroles, Il les enregistre, n’en oublie aucun et nous les rétribuera en conséquence.",
      ...
      "Il est le Créateur, Il nous fait vivre par Sa Grâce, Il fait, Il répand ses bienfaits sur nous. C’est Lui qui met fin à notre existence et nous ressuscite sans aucun doute.",
      "Après nous avoir ressuscités, Il nous rassemblera en un jour, en un lieu et nous lui rendons compte de nos actes, chacun en ce qui le concerne.",
...
const page4_blocks = [
  {
    type: "text_block",
    content: [
      "Notre Prophète Mouhammadou Rassoû Loulahi (PSL), Serviteur de Dieu, est son Messager qu’il a envoyé auprès de tout le monde. Tout ce qu’il dit, tout ce qu’il fait est conforme aux instructions divines.",
      "Celui qui en conteste une partie, si petite soit-elle, est un mécréant. Qui en retranche ou en rajoute tant soit peu est digne du plus grand mépris. S’il ne s’en repent pas, il sera précipité dans les feux de l’enfer.",
      "L’objet de sa mission est de nous révéler que nous devons nous soumettre à ses recommandations. La plus importante parmi celles-ci est la prière (cinq fois par jour)."
    ]
  }
];
...
const page5a_blocks = [
  ...
  },
  {
    ...
    content: [
      ...
      "Enfin, laver les deux pieds qui auraient dû l'être lors de l'ablution. S'il s'agit de la purification en vue de la prière de vendredi, les pieds doivent être lavés au moment de l'ablution.",
  ...
  },
  {
    ...
    content: [
      {
        titleFr: "Les pratiques obligatoires (Farata)",
        titleAr: "الفراض",
        items: [
      ...
      {
        titleFr: "Les pratiques traditionnelles (Souna)",
        titleAr: "السنن",
        items: [
          ...
          "5. Faire passer l'eau par les oreilles en prenant soin de ne pas trop la faire pénétrer (s'assurer également que les aisselles, les plis et parties cachées sont mouillés)"
        ]
      }
    ]
  }
...
const page5b_blocks = [
  ...
  {
    type: "procedure",
    titleFr: "Causes pouvant rendre caduques les ablutions",
    ...
    content: [
      ...
      "9. L'évanouissement.",
      "10. L'ivresse.",
      "11. Le sommeil profond, si court soit-il. Il s'agit de sommeil pendant lequel un objet que l'on a dans sa main pourrait tomber sans qu'on s'en aperçoive ; ou durant lequel on serait amené à baver.",
      "12. L'attouchement du corps d'une femme, de ses cheveux, de ses ongles, ou de ses habits par un homme majeur avec l'intention d'en jouir, qu'il y trouve ou non du plaisir, si cette femme est capable et est en âge de lui procurer du plaisir ; s'il y trouve du plaisir sans l'avoir cherché. Si le plaisir n'est ni recherché, ni obtenu, l'ablution n'est pas annulée. Cela s'applique aussi à la femme. L'attouchement entre mineurs est sans effet.",
      ...
      "14. Le fait pour un homme de toucher sa verge par la paume, les doigts ou le contour de la main annule l'ablution. L'attouchement de la verge même par-dessus les habits ne l'annule pas. L'attouchement des parties intimes en dehors de la verge ne l'annule pas. Quant à la femme qui touche son sexe, il n'y a pas d'annulation même si cela se fait par le doigt.",
    ...
    content: [
      {
        ...
        paragraphs: [
          "Consiste à laver proprement les parties intimes avec de l’eau non souillée, non altérée dans sa couleur, sa saveur et dans son odeur avant de quitter les lieux de toilettes. Il est donc conseillé d’y aller avec de l’eau.",
          "S’il s’agit de toilettes, il est méritoire d’introduire le pied gauche et de dire avant d’entrer : « Bismilahi allahouma iniya a hons oubika minal khouboussi wal khabâ issi. » Une fois à l’intérieur, on ne prononce plus la formule.",
          "Il est aussi méritoire de sortir par le pied droit et de dire : « Bismilahi alhamdoulilahi lazi azhaba anil âzâ wa hâfâni. »",
          "Si c’est en plein air, la formule d’entrée doit se dire avant de se découvrir et la formule de sortie après le besoin.",
  ...
  },
  {
    ...
    content: [
      ...
      "Après cela, lever la tête vers le ciel et dire ceci : « Achadouane lahilaha illalah wahdahô la charika lahô wa ach hadou annas seydina Mouhamadane sala lahô tahala aleyhi wassalama. Abdouho wa rassoulouhou ala houmadj halna minattawa bîna wadj halna minal moutatakhirina wadj halna mine ibâdika sahilina wa add khilnâ fil djanati wa bahidna mina nâri allahouma sali ala seydina Mouhamadine wa alla ali seydina Mouhamadine wa salim. »"
    ]
  },
  {
    type: "comparison",
    content: [
      {
        ...
        titleAr: "الفراض",
        items: [
          "1. Formuler intérieurement l'intention au moment de se laver le visage",
          "2. Se laver entièrement le visage",
          "3. Se laver les avant-bras, jusqu'aux coudes",
          "4. Laver les doigts séparément",
          "5. Faire passer l'eau sur l'ensemble des cheveux (les tresses naturelles n'ont pas besoin d'être défaîtes, contrairement aux rajouts artificiels qui doivent être enlevés)",
          ...
          "8. Observer rigoureusement l'ordre établi et laver sans trop attendre pour éviter l'assèchement d'un membre avant l'autre"
        ]
      },
      {
        titleFr: "Les pratiques traditionnelles (Souna)",
        ...
        items: [
          ...
          "5. Passer les mains à l'intérieur et à l'extérieur des oreilles",
...
const page5c_blocks = [
  {
    ...
    content: [
      ...
      "Si on souffre d’une maladie que l’eau est susceptible d’aggraver, on peut la faire chauffer ou y mettre du sel. Si malgré tout les risques d’aggravation de la maladie demeurent, on peut procéder à la lustration pulvérale.",
  ...
  },
  {
    ...
    content: [
      ...
      "La lustration pulvérale ne peut servir qu’à une seule prière obligatoire. Cependant, on pourra s’en servir après pour une prière surérogatoire, pour lire le Coran ou pour toute autre pratique traditionnelle si l’intention en a été formulée. Donc à chaque pratique obligatoire sa lustration pulvérale.",
      "Celui qui n’a pas d’eau et qui n’est ni malade, ni en déplacement, n’a le droit de pratiquer la lustration pulvérale en vue de prier sur un mort que lorsqu’il n’a que lui pour le faire. Il ne peut non plus procéder à la lustration pulvérale pour une prière surérogatoire qui n’est pas consécutive à une prière obligatoire.",
      "Celui qui pratique la lustration pulvérale pour lire le Coran ou pour toute autre pratique traditionnelle doit formuler intérieurement l’intention de s’en servir pour lire le Coran ou faire la pratique en question et s’y mettre immédiatement, faute de quoi, la lustration n’est plus valable."
    ]
  },
  {
    type: "comparison",
    content: [
      {
        ...
        items: [
          ...
          "6. Respecter l’ordre établi avec rapidité pour éviter la nullité.",
          "7. Accomplir aussitôt après ce pourquoi on a fait la lustration.",
          "8. Faire la lustration à l’heure prescrite for la prière. Si faite avant, la prière est nulle."
        ]
      },
      {
        titleFr: "Les pratiques traditionnelles (Souna)",
    ...
    content: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Si le chien trempe la langue sans la remuer ou s’il salive dans le récipient ou s’il se contente seulement de le lécher, dans ce cas, l’eau comme le récipient est utilisable. Il en est de même s’il s’agit de récipient contenant un aliment liquide comme le lait caillé, il en est aussi de même si la quantité d’eau excède deux litres."
        ]
      },
      {
        label: "EAUX COURANTES ET SOURCES",
        paragraphs: [
          "S’il s’agit d’une eau courante comme celle des marigots, des lacs, des citernes ou des bassins, si un animal tombe dans cette eau et y meurt sans l’altérer, il est recommandé d’enlever la partie de l’eau susceptible de contenir quelque chose qui provient de l’animal. Tout cela dépend de la taille de l’animal et de la quantité de l’eau. S’il s’agit d’une eau courante ou d’une eau provenant d’une source, si elle n’est pas altérée, on ne doit pas non plus procéder à son dragage.",
    ...
    content: [
      {
        ...
        paragraphs: [
          "C’est l’écoulement de sang propre à la femme de 9 ans au moins et de 70 ans au plus ; cet écoulement est périodique et non provoqué. On distingue là, trois (3) catégories de femmes : a) celle à qui cela vient d’arriver, b) celle qui en est habituée, c) la femme enceinte."
        ]
      },
      {
      ...
      },
      {
        ...
        paragraphs: [
          "On rencontre rarement l’écoulement de sang chez la femme enceinte. Si cela arrivait, les menstrues interviennent rarement avant les deux premiers mois de la grossesse.",
          "Entre le deuxième et le sixième mois, cet écoulement ne peut excéder vingt (20) jours. Au-delà des 20 jours, elle doit se laver, faire ses prières, jeûner et reprendre ses rapports.",
          ...
          "Entre le sixième et le terme de la grossesse, l’écoulement ne peut excéder trente (30) jours. Si la durée excède trente (30) jours il ne s’agit plus de menstrues mais de maladie. Elle peut se laver, faire ses prières, jeûner et reprendre ses rapports. S’il y a interruption reprise des menstrues, et que l’interruption ne dure pas quinze (15) jours, elle fait la somme des jours de l’écoulement jusqu’à concurrence de trente (30) jours."
        ]
      },
      {
        label: "RECONNAÎTRE L'ARRÊT",
        paragraphs: [
      ...
      {
        label: "LES INTERDICTIONS ET RÈGLES",
        paragraphs: [
          ...
          "Elle ne doit pas jeûner mais doit obligatoirement s’en acquitter à titre compensatoire. Elle ne doit pas faire le tour de la Kaaba. Elle ne doit pas observer de retraite d’adoration « lihtikaf ». Elle ne peut pas avoir de rapports sexuels. Elle ne doit pas être répudiée.",
          "On ne doit pas flirter avec elle ni chercher à tirer du plaisir de la partie du corps comprise entre le nombril et les genoux. Elle ne doit pas entrer dans une mosquée. Elle ne doit toucher au Coran que pour l’enseigner ou l’étudier, mais elle peut le réciter. La prière, le jeûne, le tour de la Kaaba, la retraite, le flirt, les rapports sexuels, la répudiation et toute autre pratique, ne lui sont possibles qu’après l’arrêt des menstrues, ces interdits demeurent jusqu’à ce que la purification soit faite.",
    ...
    content: [
      {
        ...
        paragraphs: [
          ...
          "Si s’il y a interruption et reprise des lochies et que la durée de cette interruption égale quinze (15) jours, il ne s’agit plus de lochies, ni d’une maladie, mais de menstrues.",
      ...
      {
        label: "CONSEILS ET PRATIQUES MÉRIITOIRES",
        paragraphs: [
...
const page6_blocks = [
  {
    type: "quote",
    content: [
      "Obligation est faite à tout musulman majeur de s’acquitter des cinq (5) prières quotidiennes. Quiconque nie cela est un mécréant ; celui qui y renonce délibérément et sans aucune dispense est un impie.",
      "Seule la démence peut dispenser de la prière. Toute personne qui jouit de ses facultés mentales doit obligatoirement s’acquitter de ces prières, quelles que soient ses incapacités physiques, quand bien même elle doit les faire par mimique.",
      "Celui qui ne les accomplit pas aux heures prescrites encourt les mêmes sanctions que celles citées ci-dessus ; il n’est pas digne de foi. Selon la charia, il doit être condamné à mort ; il sera irrémédiablement précipité dans la géhenne s’il ne s’en repent pas."
    ]
  },
  {
    type: "split_text",
    content: [
      {
        label: "Les pratiques de la prière",
        paragraphs: [
          "Après la purification du corps, des habits et des lieux de prière, il faut cacher au moins ses parties intimes, faute de quoi la prière n’est pas valable. S’il s’agit d’un homme, il doit se couvrir des épaules jusqu’aux genoux.",
          "Quant à la femme, elle doit se couvrir tout le corps à l’exception des paumes des mains et du visage. Toute partie devant être couverte et qui ne l’est pas chez l’homme ou la femme annule la prière."
        ]
      }
    ]
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        "icon": "assignment",
        "title": "PRATIQUES OBLIGATOIRES",
        "letter": "D",
        "subtitle": "Cas spéciaux"
      },
      {
        "ar": "السنن",
        "sub": [
        ...
        "icon": "groups",
        "title": "PRATIQUES TRADITIONNELLES",
        "letter": "E",
        "subtitle": "Communauté"
      },
      {
      ...
      },
      {
        "ar": "قضاء",
        "sub": [
          "Règles du rattrapage"
        ],
        "icon": "history",
        "title": "PRIÈRES NON EFFECTUÉES",
        "letter": "G",
        "subtitle": "Rattrapage"
      },
      {
      ...
      },
      {
        "ar": "أفعال",
        "sub": [
          "Méritoires et blâmables"
        ],
        "icon": "accessibility_new",
        "title": "ACTES DURANT LA PRIÈRE",
        "letter": "I",
...
async function main() {
  console.log("🚀 Lancement de la mise à jour complète de la DB avec TOUS les détails...\n");

  await upsert('2', page2_blocks);
  await upsert('3', page3_blocks);
  await upsert('4', page4_blocks);
  ...
  await upsert('6', page6_blocks);

  console.log("\n✅ Toutes les mises à jour exhaustives sont terminées !");
}
